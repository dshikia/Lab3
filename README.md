...
9. Подсчёт печатаемых слов из строки (WordText)
...
10. Анализ напечатанного слова (AnWord)
...
11. Восстановление/поломка нескольких клавиш (BosstanPolomka)
